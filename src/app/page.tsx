import { BsGithub, BsPatchCheckFill, BsFillSendFill } from 'react-icons/bs';
              ...
              <div className=" flex flex-col justify-stretch space-y-3 sm:flex-row sm:space-y-0 sm:space-x-4">
                <div className="relative group">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="relative px-6 py-3 bg-black leading-none flex items-center divide-x divide-gray-600  text-sm font-medium rounded-md font-mono focus:outline-none focus:ring-0 transition-all"
                  >
                    <BsGithub className="mr-3 h-5 w-5" />
                    <span className="text-pink-600 pl-3 group-hover:text-gray-100">
                      View GitHub Profile
                    </span>
                  </a>
                </div>
      ...
      <section id="about" className={`container mt-16`}>
        ...
        <article className="max-w-2xl mt-3 gap-4 grid">
          <p>
            ...
            <span className="bg-pink-600 p-1">Robin Singh</span>! from New
            Delhi, India, a passionate self-taught{' '}
          ...
          <div className="flex flex-wrap gap-10">
            ...
            <ul>
              <p className="underline underline-offset-4">Tools & Platforms</p>
              <li>Git</li>
              <li>GitHub</li>
              <li>Netlify</li>
              <li>Vercel</li>
